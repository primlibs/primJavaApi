...
/**
 * переводит чисел в слова http://habrahabr.ru/post/76171/
 *
 * @author Pavel Rice
 */
public class NumToWordsFilter extends ValidatorAbstract {

  /**
   * показывать ли копейки
   */
  private boolean penny = true;
  /**
   * сумма денег
   */
    ...
    try {
      ...
      if (rub == 0) {// если Ноль
        ...
        if (!penny) {
          ...
          data = o + " " + kop + " " + morph(kop, forms[ 0][ 0], forms[ 0][1], forms[ 0][2]);
          return true;
        }
      }
      // Больше нуля
      ...
      setErrorMessage("неправильный формат значения - требуется число");
      return false;
    }
  }
  ...
  public void setPenny(Object penny) {
    this.penny = Boolean.parseBoolean(penny.toString());
  }
